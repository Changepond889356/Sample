...
public class Carrier_ShareAll_TC021 extends SetUp {
	@Test
	public void main() throws Exception {
		String sTestCaseID = "Carrier_ShareAll_TC021";
		...
		try {
			...
			if (bResult == true) {
				...
				if(bResult==true)
				{
					...
					bResult = TestActions.Login("Carrier_ShareAll_TC021(2)");
					if(bResult==true)
					{
						bResult=false;
						//check shared deal
						bResult=Deals.DealWidget("Carrier_ShareAll_TC021(2)");
						if(bResult==true)
						{
							TestActions.LogOut();
