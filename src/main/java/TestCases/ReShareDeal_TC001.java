...
public class ReShareDeal_TC001 extends SetUp {
	@Test
	public void main() throws Exception {

		String sTestCaseID = "ReShareDeal_TC001";
			...
			if (bResult == true) {
				...
				if (bResult == true) {
					...
					if (bResult == true) {
						...
						bResult = Deals.DealWidget("ReShareDeal_TC001(2)");
						if (bResult == true) {
							// bResult = false;
							...
							if (bResult == true) {
								bResult = false;
								// Re share to contact
								bResult = Share.ShareDeal("ReShareDeal_TC001(2)");
