...
public class ShareDeal_TC002 extends SetUp {
	@Test
	public void main() throws Exception {
		String sTestCaseID = "ShareDeal_TC002";
			...
			if (bResult == true) {
				...
				if(bResult==true)
				{
					...
					if(bResult==true)
					{
						...
						bResult = TestActions.Login("ShareDeal_TC002(2)");
						if(bResult==true)
						{
							bResult=false;
							//check shared deal
							bResult=Deals.DealWidget("ShareDeal_TC002(2)");
							if(bResult==true)
							{
								TestActions.LogOut();
