...
public class PublicShareDeal_TC001 extends SetUp {
	@Test
	public void main() throws Exception {
		String sTestCaseID = "PublicShareDeal_TC001";
			...
			if (bResult == true) {
				...
				if(bResult==true)
				{
					...
					if(bResult==true)
					{
						...
						bResult = TestActions.Login("PublicShareDeal_TC001(2)");
						if(bResult==true)
						{
							bResult=false;
							//check shared deal
							bResult=Deals.DealWidget("PublicShareDeal_TC001(2)");
							if(bResult==true)
							{
								TestActions.LogOut();
