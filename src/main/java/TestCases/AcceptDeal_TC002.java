...
public class AcceptDeal_TC002 extends SetUp {
	@Test
	public void main() throws Exception {
		String sTestCaseID = "AcceptDeal_TC002";
			...
			if (bResult == true) {
				...
				if (bResult == true) {
					...
					if (bResult == true) {
						...
						TestActions.LogOut();
						//login as carrier
						bResult = TestActions.Login("AcceptDeal_TC002(2)");
						if(bResult==true)
						{
							bResult=false;
							bResult = Deals.DealWidget("AcceptDeal_TC002(2)");
							if (bResult == true) {
								...
								if(bResult==true)
								{
									...
									TestActions.LogOut();
									bResult = TestActions.Login("AcceptDeal_TC002(2)");
									bResult=Deals.DealWidget("AcceptDeal_TC002(3)");
									if(bResult==true)
									{
										TestActions.LogOut();
