...
public class ReShareDeal_TC002 extends SetUp {
	@Test
	public void main() throws Exception {

		String sTestCaseID = "ReShareDeal_TC002";
			...
			if (bResult == true) {
				...
				if (bResult == true) {
					...
					if (bResult == true) {
						...
						bResult = Deals.DealWidget("ReShareDeal_TC002(2)");
						if (bResult == true) {
							// bResult = false;
							...
							if (bResult == true) {
								bResult = false;
								// Re share to contact
								bResult = Share.ShareDeal("ReShareDeal_TC002(2)");
