	...
	public void chatFeatures(String sAcccountType, String sName, String sUserName, String sPassword) throws Exception {
		...
		try {
			...
			if (bResult == true) {				
				...
				if (bResult == true) {				
					//Send Message
					bResult = Chat.ChatValidation(sTestCaseID,sName, 37); 
			...
			if(bResult==true)
			{
				...
				if (bResult == true) {	
					//Verify Message
					bResult = Chat.ChatValidation(sTestCaseID,sName, 38); 
