...
public class NegotiateDeal_TC003 extends SetUp {
	@Test
	public void main() throws Exception {

		String sTestCaseID = "NegotiateDeal_TC003";
			...
			if (bResult == true) {
				...
				if (bResult == true) {
					...
					if (bResult == true) {
						...
						bResult = Deals.DealWidget("NegotiateDeal_TC003(2)");
						if (bResult == true) {
							bResult = false;
							bResult = Deals.DealWidget("NegotiateDeal_TC003(3)");
							if (bResult == true) {
