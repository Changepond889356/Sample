...
public class WithDrawDeal_TC003 extends SetUp {
	@Test
	public void main() throws Exception {

		String sTestCaseID = "WithDrawDeal_TC003";
			...
			if (bResult == true) {
				...
				if (bResult == true) {
					...
					if (bResult == true) {
						...
						bResult = Deals.DealWidget("WithDrawDeal_TC003(2)");
						if (bResult == true) {
							bResult = false;
							bResult = Deals.DealWidget("WithDrawDeal_TC003(3)");
							if (bResult == true) {
								TestActions.LogOut();
