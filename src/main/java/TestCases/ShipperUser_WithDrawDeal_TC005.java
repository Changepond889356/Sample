...
public class ShipperUser_WithDrawDeal_TC005 extends SetUp {
	@Test
	public void main() throws Exception {

		String sTestCaseID = "ShipperUser_WithDrawDeal_TC005";
			...
			if (bResult == true) {
				...
				if (bResult == true) {
					...
					if (bResult == true) {
						...
						bResult = Deals.DealWidget("ShipperUser_WithDrawDeal_TC005(2)");
						if (bResult == true) {
							bResult = false;
							bResult = Deals.DealWidget("ShipperUser_WithDrawDeal_TC005(3)");
							if (bResult == true) {
								TestActions.LogOut();
