...
public class WithDrawDeal_TC001 extends SetUp {
	@Test
	public void main() throws Exception {

		String sTestCaseID = "WithDrawDeal_TC001";
			...
			if (bResult == true) {
				...
				if (bResult == true) {
					...
					if (bResult == true) {
						...
						bResult = Deals.DealWidget("WithDrawDeal_TC001(2)");
						if (bResult == true) {
							bResult = false;
							bResult = Deals.DealWidget("WithDrawDeal_TC001(3)");
							if (bResult == true) {
								TestActions.LogOut();
