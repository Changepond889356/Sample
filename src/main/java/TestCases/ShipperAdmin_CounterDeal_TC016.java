...
public class ShipperAdmin_CounterDeal_TC016 extends SetUp {
	@Test
	public void main() throws Exception {
		String sTestCaseID = "ShipperAdmin_CounterDeal_TC016";
			...
			if (bResult == true) {
				...
				if (bResult == true) {
					...
					if (bResult == true) {
						...
						if(bResult==true)
						{
							bResult = Deals.DealWidget("ShipperAdmin_CounterDeal_TC016(2)");
							if(bResult==true)
							{
								TestActions.LogOut();
								bResult=TestActions.Login(sTestCaseID);
								if(bResult==true)
								{
									bResult = Deals.DealWidget("ShipperAdmin_CounterDeal_TC016(3)");
									if (bResult == true) {
