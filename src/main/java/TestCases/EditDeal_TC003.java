...
public class EditDeal_TC003 extends SetUp {
	@Test
	public void main() throws Exception {

		String sTestCaseID = "EditDeal_TC003";
			...
			if (bResult == true) {
				...
				if (bResult == true) {
					...
					if (bResult == true) {
						...
						bResult = Deals.DealWidget("EditDeal_TC003(2)");
						if (bResult == true) {
							bResult = false;
							bResult = Deals.EditDeal(sTestCaseID);
							if(bResult==true)
							{   bResult=false;
								bResult = Deals.DealWidget("EditDeal_TC003(3)");
								if (bResult == true) {
									TestActions.LogOut();
