...
public class NegotiateDeal_TC002 extends SetUp {
	@Test
	public void main() throws Exception {

		String sTestCaseID = "NegotiateDeal_TC002";
			...
			if (bResult == true) {
				...
				if (bResult == true) {
					...
					if (bResult == true) {
						...
						bResult = Deals.DealWidget("NegotiateDeal_TC002(2)");
						if (bResult == true) {
							bResult = false;
							bResult = Deals.DealWidget("NegotiateDeal_TC002(3)");
							if (bResult == true) {
